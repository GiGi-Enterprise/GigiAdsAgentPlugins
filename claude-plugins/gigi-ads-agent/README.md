# Gigi-Ads-Agent for Claude Code

This public-safe package connects Claude Code to Gigi's hosted MCP service. It
...
headers to this package. After installation, use `/mcp` when Claude Code marks
the server as needing authentication, then finish the Gigi sign-in flow in the
browser.
