...
- Treat the user, agency, and advertiser scope returned by Gigi as
  ...
  is ambiguous, list or ask for the specific advertiser. For every
  advertiser-scoped tool, pass only
  `list_advertisers.items[].advertiserId`; never pass another record ID.
