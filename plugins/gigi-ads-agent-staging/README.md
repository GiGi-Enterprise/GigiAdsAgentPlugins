# Gigi-Ads-Agent (Staging) for Codex

This GitHub-only package connects Codex to Gigi's non-production staging
environment. It is for engineering and invited tester use and will not be
submitted to the OpenAI Plugins Directory.
