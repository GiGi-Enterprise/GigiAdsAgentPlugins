# Gigi-Ads-Agent (Beta) for Codex

This GitHub-only package connects Codex to Gigi's Beta environment, which is
backed by the non-production pre-prod service. It is for release-candidate
testing and will not be submitted to the OpenAI Plugins Directory.
