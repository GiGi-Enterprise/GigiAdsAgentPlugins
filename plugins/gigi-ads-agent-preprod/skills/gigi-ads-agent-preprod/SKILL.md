---
name: gigi-ads-agent-preprod
description: Verify Gigi tasks, feed cards, metrics, advertiser context, knowledge, and campaign intake in the non-production pre-prod environment.
---

# Gigi-Ads-Agent (Pre-Prod)

Use the pre-prod Gigi MCP tools for release-candidate verification. Always
identify results and actions as **pre-prod**, never production.
